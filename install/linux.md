...
Linux上推荐使用ShellClash 具有很强的支持性与兼容性, 推荐使用! 由于国内一些linx开发环境下需要拉取GitHub库或者海外的api接口的情景出此教程

{% embed url="https://github.com/juewuy/ShellClash" %}
...
![](https://1-1306085497.cos.ap-shanghai.myqcloud.com/img/image%20\(1\).png)

## 导入订阅链接

在我们网站内复制你的订阅链接

将你的订阅链接后面加上Clash参数\&flag=clash,会请求我们内置的Clash规则‌

示例: 我的订阅链接**\&flag=clash**

看图‌

![image (2)](https://1-1306085497.cos.ap-shanghai.myqcloud.com/img/image%20\(2\).png)

![image (3)](https://1-1306085497.cos.ap-shanghai.myqcloud.com/img/image%20\(3\).png)
